...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "period", function () awful.layout.inc( 1)               end,
              {description = "select next", group = "layout"}),
    awful.key({ modkey, "Control"  }, "comma", function () awful.layout.inc(-1)               end,
